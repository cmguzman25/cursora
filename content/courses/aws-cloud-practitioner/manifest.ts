...
const LESSONS: LessonMeta[] = [
  ...
  { id: "12-proteccion-contra-ataques", moduleId: "module-2", module: MODULES["module-2"], title: { es: "Componentes de seguridad: protección contra ataques", en: "Security components: protecting against attacks", "pt-BR": "Componentes de segurança: proteção contra ataques" } },
  { id: "13-deteccion-y-auditoria", moduleId: "module-2", module: MODULES["module-2"], title: { es: "Componentes de seguridad: detección y auditoría", en: "Security components: detection and auditing", "pt-BR": "Componentes de segurança: detecção e auditoria" } },
  { id: "14-comparativas-seguridad", moduleId: "module-2", module: MODULES["module-2"], title: { es: "★ Tablas comparativas: seguridad", en: "★ Comparison tables: security", "pt-BR": "★ Tabelas comparativas: segurança" } },
  { id: "15-analisis-preguntas-modulo-2", moduleId: "module-2", module: MODULES["module-2"], title: { es: "Analiza preguntas de examen: seguridad", en: "Exam question breakdown: security", "pt-BR": "Análise de questões de exame: segurança" }, kind: "quiz" },

  { id: "16-formas-de-desplegar", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Formas de desplegar y operar en AWS", en: "Ways to deploy and operate on AWS", "pt-BR": "Formas de implantar e operar na AWS" } },
  { id: "17-infraestructura-global", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Infraestructura global de AWS", en: "AWS Global Infrastructure", "pt-BR": "Infraestrutura global da AWS" } },
  { id: "18-servicios-de-computo", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Servicios de cómputo", en: "Compute services", "pt-BR": "Serviços de computação" } },
  { id: "19-servicios-de-bases-de-datos", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Servicios de bases de datos", en: "Database services", "pt-BR": "Serviços de banco de dados" } },
  { id: "20-servicios-de-red", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Servicios de red", en: "Networking services", "pt-BR": "Serviços de rede" } },
  { id: "21-almacenamiento-objetos-y-bloques", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Almacenamiento — objetos y bloques", en: "Storage — objects and blocks", "pt-BR": "Armazenamento — objetos e blocos" } },
  { id: "22-almacenamiento-archivos-y-backup", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Almacenamiento — archivos y protección de datos", en: "Storage — files and data protection", "pt-BR": "Armazenamento — arquivos e proteção de dados" } },
  { id: "23-ia-ml-y-analitica", moduleId: "module-3", module: MODULES["module-3"], title: { es: "IA/ML y analítica", en: "AI/ML and analytics", "pt-BR": "IA/ML e análise de dados" } },
  { id: "24-integracion-y-soporte-al-cliente", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Integración, mensajería y soporte al cliente", en: "Integration, messaging, and customer engagement", "pt-BR": "Integração, mensageria e atendimento ao cliente" } },
  { id: "25-desarrollo-end-user-computing-e-iot", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Desarrollo, cómputo para el usuario final e IoT", en: "Developer tools, end-user computing, and IoT", "pt-BR": "Ferramentas de desenvolvedor, computação para o usuário final e IoT" } },
  { id: "26-comparativas-tecnologia-y-servicios", moduleId: "module-3", module: MODULES["module-3"], title: { es: "★ Tablas comparativas: tecnología y servicios", en: "★ Comparison tables: technology and services", "pt-BR": "★ Tabelas comparativas: tecnologia e serviços" } },
  { id: "27-analisis-preguntas-modulo-3", moduleId: "module-3", module: MODULES["module-3"], title: { es: "Analiza preguntas de examen: tecnología y servicios", en: "Exam question breakdown: technology and services", "pt-BR": "Análise de questões de exame: tecnologia e serviços" }, kind: "quiz" },

  { id: "28-modelos-de-precios", moduleId: "module-4", module: MODULES["module-4"], title: { es: "Modelos de precios", en: "Pricing models", "pt-BR": "Modelos de preços" } },
