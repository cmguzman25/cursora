...
const LESSONS: LessonMeta[] = [
  ...
  { id: "08-analisis-preguntas-modulo-1", moduleId: "module-1", module: MODULES["module-1"], title: { es: "Analiza preguntas de examen: conceptos de la nube", en: "Exam question breakdown: cloud concepts", "pt-BR": "Análise de questões de exame: conceitos de nuvem" } },
