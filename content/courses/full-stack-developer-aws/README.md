...
- [ ] 2.1 Por qué IAM es lo primero que revisa un profesional (`lecciones/02-01-por-que-importa-iam.es.md`)
- [ ] 2.2 Usuarios, grupos y root: quién es quién en tu cuenta (`lecciones/02-02-usuarios-grupos-root.es.md`)
...
**11 / 184 lecciones desarrolladas.**
